...
# get data from file
alldata = np.loadtxt("am15.csv") # file should be downloaded together with notebook exercise.
...
norm = np.sum(spectrum) # YR: this variable is needed in the test, leave name unchanged.
