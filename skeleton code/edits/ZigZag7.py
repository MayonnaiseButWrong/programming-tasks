    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                ...
                choiceOptions=self._CurrentPlayer.getChoiceOptionsLeft()
                if Choice == 9:
                    if choiceOptions>0:
                        self._CurrentPlayer.updateChoiceOptions()
                        print("you have "+choiceOptions+" offers left")
                        self.__UseMoveOptionOffer()
                        self.__DisplayState()
                    else:
                        print('you dont have any offers left')
