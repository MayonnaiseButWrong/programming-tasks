...
class Dastan:
    ...
    def __CreateBoard(self):
        self._Kotlapos1 = int(input('Player 1, choose a square where to put your Mirza: '))
        self._Kotlapos2 = int(input('Player 2, choose a square where to put your Mirza: '))
        for Row in range(1, self._NoOfRows + 1):
            for Column in range(1, self._NoOfColumns + 1):
                if Row == self._Kotlapos1//10 and Column == self._Kotlapos1%10:
                    S = Kotla(self._Players[0], "K")
                elif Row == self._Kotlapos2//10 and Column == self._Kotlapos2%10:
    ...
    def __CreatePieces(self, NoOfPieces):
        ...
        self._Board[self.__GetIndexOfSquare(self._Kotlapos1)].SetPiece(CurrentPiece)
        for Count in range(1, NoOfPieces + 1):
        ...
        self._Board[self.__GetIndexOfSquare(self._Kotlapos2)].SetPiece(CurrentPiece)
