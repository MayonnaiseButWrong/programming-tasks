...
class Dastan:
    ...
    def __AwardWafr(self):
        return random.choice([True,False,False,False]) #25%chance of wafr being awarded
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                ...
                if Choice == 9:
                    ...
                    self.__DisplayState()
            if self._CurrentPlayer.GetWafrAwarded()==False and self.__AwardWafr()==True:
                self._CurrentPlayer.SetWafrAwarded(True)
                AwardWafr = True
                print('You have been awarded a Wafr, you can select any move from your queue for free this turn')
