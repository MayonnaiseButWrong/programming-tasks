...
#edit
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            Choice = 0
#edit
            wafrAwarded = self.__AwardWafr()
            if wafrAwarded:
                print('you have been awarded the wafr, your move have no cost for this round')
#edit
...
#edit
    def GetWafrAwarded(self):
        return self.__WafrAwardeed

    def SetWafrAwarded(self,v):
        self.__WafrAwardeed=v
#edit
    def GetName(self):
        return self.__Name
