...
class Dastan:
    ...
    def PlayGame(self):
        GameOver = False
#edit
        self._Players[0].ConfirmQueue()
        self._Players[1].ConfirmQueue()
#edit
        while not GameOver:
            self.__DisplayState()
            SquareIsValid = False
...
#edit
            if str(input('Do you want to confirm your move (y/n): ')).lower()=='y':
                self._CurrentPlayer.ConfirmQueue()
                if MoveLegal:
                ...
                self._CurrentPlayer.ResetQueue()
#edit
...
class Player:
    def __init__(self, N, D):
        ...
        self.__OldQueue = MoveOptionQueue()
...
#edit
    def ConfirmQueue(self):
        self.__OldQueue.AddNewQueue(self.__Queue.GetJustQueue())

    def ResetQueue(self):
        self.__Queue.AddNewQueue(self.__OldQueue.GetJustQueue())
#edit
